...
const Home = () => {
  ...
  return (
    <div className="homepage-container" ref={containerRef}>
      ...
      {/* New products*/}
      <section className="homepage-section newproduct-section" data-nav-style="logo-only-dark">
      ...
      {/* Intro */}
      <section className="homepage-section intro-section" data-nav-style="logo-only-dark">
        <div className="section-content container pt-5">
          <div className='row'>
      ...
      <section className="homepage-section trends-section" data-nav-style="full-dark" >
      ...
      {/* Details */}
      <section className="homepage-section details-section" data-nav-style="full-dark" >
